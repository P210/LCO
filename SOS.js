...
export default class SOSscreen extends React.Component{
  ...
  async componentDidMount(){
    // Here we are searching name or a phone number whatever user gives it will fill up the data
          ...
          <View>
                ...
                <ImageBackground source={require('../assets/bg.png')} style={styles.image}>                                       
                    ...
                    <View>
                        ...
                        <Image source={require('../assets/back-icon.png')} style={{width:50, height:50}}/>
                            <Text>BACK</Text>
                        </TouchableOpacity>
                    </View>   
